...
def meets_minimum_requirements(csaf: dict) -> tuple[bool, list[str]]:
    """Check conversion requirements using the existing public entry point."""
    return __meets_minimum_requirements(csaf)
